...
class TranslateCmsPagesCommand extends Command
{
    ...
    {
        $this->setName('deepl:translate:cms-pages');
        $this->setDescription('Translate all CMS pages into a specific store view');
        ...
        $this->addOption('batch-size', null, InputOption::VALUE_REQUIRED, 'Number of pages to process per batch', '50');
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            $output->writeln(sprintf('Found %d CMS pages to translate.', $total));
            ...
            foreach ($pageIds as $index => $pageId) {
                ...
                try {
                    $this->cmsPageTranslator->translate((int)$pageId, $targetStoreId, $sourceLanguage, $targetLanguage, $dryRun, $output, $force);
                } catch (\Exception $e) {
            ...
            $output->writeln(sprintf('Translation complete. %d/%d CMS pages processed. %d failed.', $total - $failed, $total, $failed));
