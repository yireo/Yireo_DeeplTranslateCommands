...
class TranslateCategoryCommand extends Command
{
    ...
    {
        $this->setName('deepl:translate:category');
        $this->setDescription('Translate a single category into a specific store view');
